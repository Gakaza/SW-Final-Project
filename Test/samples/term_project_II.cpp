...
int main1(){
	...
	int num_Price0 = 0, num_Price1 = 0, numPerPrice[2][3] = {0};
...
void tempPriceClass(char tempAttribute[ ][30], int (&numPerPrice)[2][3], int &num_Price0, int &num_Price1){
	//double tempPrice; int numPerPrice[2][3] = {0}, num_Price0 = 0, num_Price1 = 0;
	double tempPrice = strtod(tempAttribute[15], NULL);
	if(tempPrice >= 94.45 && tempPrice < 2000){
		if(strcmp(tempAttribute[19],"no") == 0){
			numPerPrice[0][0]++;			
			num_Price0++;
		}else{
	...
	}else if(tempPrice <= 92.8 && tempPrice >= 0){
		if(strcmp(tempAttribute[19],"no") == 0){
			numPerPrice[0][2]++;			
			num_Price0++;
		}else{
...
void tempEuribor3mClass(char tempAttribute[ ][30], int (&numPerEuribor3m)[2][4], int &num_Euribor3m0, int &num_Euribor3m1){
	...
	double tempEuribor3m = strtod(tempAttribute[17],NULL);
	...
	}else if(tempEuribor3m < 1.0 && tempEuribor3m >0){
		if(strcmp(tempAttribute[19],"no") == 0){
			numPerEuribor3m[0][3]++;			
			num_Euribor3m0++;
		}else{
